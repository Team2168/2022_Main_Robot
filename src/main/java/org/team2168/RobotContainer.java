...
;
  ...
  private void configureButtonBindings() {
    ...
    climber.setDefaultCommand(new DriveClimber(climber, oi.operatorJoystick::getRightStickRaw_Y));
    ...
    oi.operatorJoystick.ButtonRightBumper().whenPressed(new SetIntakeSpeed(intakeRoller, 0.5));
    oi.operatorJoystick.ButtonRightBumper().whenReleased(new SetIntakeSpeed(intakeRoller, 0.0));

    oi.operatorJoystick.ButtonLeftBumper().whenPressed(new SetIntakeSpeed(intakeRoller, -0.5));
    ...
    oi.testJoystick.ButtonA().whenPressed(new SetShooterSpeed(m_shooter, 0.0));
    oi.testJoystick.ButtonB().whenPressed(new SetShooterSpeed(m_shooter, 216.8));
    oi.testJoystick.ButtonY().whenPressed(new SetShooterSpeed(m_shooter, 2168.0));
    ...
    oi.testJoystick.ButtonRightBumper().whenPressed(new SetIntakeSpeed(intakeRoller, 0.5));
    oi.testJoystick.ButtonRightBumper().whenReleased(new SetIntakeSpeed(intakeRoller, 0.0));

    oi.testJoystick.ButtonRightDPad().whenPressed(new DriveHopperAndIndexer(hopper, indexer));
    oi.testJoystick.ButtonRightDPad().whenReleased(new DriveHopperAndIndexer(hopper, indexer));

    oi.testJoystick.ButtonUpDPad().whenPressed(new DriveHopperUntilBall(hopper, () -> 0.2));
