...
;
  ...
  private void configureButtonBindings() {
    ...
    oi.operatorJoystick.ButtonRightBumper().whenPressed(new IntakeSpeed(intakeRoller));
    oi.operatorJoystick.ButtonLeftBumper().whenReleased(new StopIntakeMotor(intakeRoller));
  }
