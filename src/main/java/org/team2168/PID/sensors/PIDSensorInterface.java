...
public interface PIDSensorInterface {
	...
	/**
	 *
	 * @return the current Position of the sensor in nominal units of the sensor for X.
	 *         Remember when using this method with a PID controller to ensure that
	 *         the setPoints of the PID controller are in the same unit as returned
	 *         by this function.
	 */
	...
	/**
	 *
	 * @return the current Position of the sensor in nominal units of the sensor for Y.
	 *         Remember when using this method with a PID controller to ensure that
	 *         the setPoints of the PID controller are in the same unit as returned
	 *         by this function.
	 */
