...
public class BackOfTarmac extends ParallelCommandGroup {
  /** Creates a new BackOfTarmac. */
  private Hood hood;
  private Shooter shooter;
  public BackOfTarmac(Hood h, Shooter s) {
    hood = h;
    shooter = s;
    ...
    addCommands(
      ...
      new SetShooterSpeed(shooter, ShooterRPM.TEST.rpm)
    );
  }
}
